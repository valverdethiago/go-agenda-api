...
func (m *MockStore) Create(arg0 Contact) (Contact, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) FindByID(arg0 string) (Contact, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) FindByName(arg0 string) ([]Contact, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetAll() ([]Contact, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) Update(arg0 Contact) error {
	m.ctrl.T.Helper()
